...
public class MainActivity extends AppCompatActivity {
    ...
    private void predictPic(Uri uri) throws IOException {
        ...
        Log.d(TAG, "input data type: " + inputDataType.name());
        Log.d(TAG, "output shape: " + Arrays.toString(outputShape));
        Log.d(TAG, "output data type: " + outputDataType.name());
        ...
        Log.d(TAG, "labels: " + Arrays.toString(labels.toArray()));

        float[] resultList = outputBuffer.getFloatArray();
        Log.d(TAG, "result: " + Arrays.toString(resultList));
